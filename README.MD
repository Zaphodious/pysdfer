...
options:
  ...
  --idempotent          Records the hashes of source image files ('.csdf_idempotent_stash.json' in path-in), and when
                        running again only converts files that have changed. Only has an
